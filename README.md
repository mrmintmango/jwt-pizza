...
![Coverage badge](https://pizza-factory.cs329.click/api/badge/rmatos1/jwtpizzacoverage?t=1)

[![CI Pipeline](https://github.com/mrmintmango/jwt-pizza/actions/workflows/ci.yml/badge.svg)](https://github.com/mrmintmango/jwt-pizza/actions/workflows/ci.yml)
...
1. Fork this repository ![Fork repo](forkRepo.png)
   ...
   ```sh
   git clone https://github.com/mrmintmango/jwt-pizza.git
   ```
